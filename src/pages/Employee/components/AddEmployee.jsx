...
const AddEmployee = ({ setShowModal }) => {
  ...
  return (
    <div className="p-4 bg-white text-sm">
      <h2 className="font-semibold mb-4 text-lg">Add New Employee</h2>
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 capitalize text-left">
        <div>
          ...
          />
          {errors.employeeName && <p className="text-red-500">{errors.employeeName.message}</p>}
        </div>
        ...
        <div className="flex justify-end space-x-2">
          <button
            type="submit"
            className="bg-gradient-to-bl from-[#fa2912] to-[#880e00] text-white shadow-lg rounded px-4 py-2"
          >
            Add New User
          </button>
          <button
